...
export default function LandingPage() {
  ...
  useEffect(() => {
    if (!document.getElementById('braindesk-demo-widget')) {
      ...
      script.dataset.greeting = "Hey! 👋 I'm a live AI agent. Ask me anything, use 🎙️ Voice, or say \"Book a demo\" to watch me schedule a meeting autonomously!";
      script.dataset.position = 'bottom-right';
      script.dataset.requireLead = 'false';
      script.dataset.starterPrompts = "What can you do?, Book a demo, Tell me about Voice AI";
